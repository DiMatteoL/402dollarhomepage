      ...
      <div className="relative w-full max-w-2xl animate-fade-in overflow-hidden rounded-xl border border-[var(--color-border)] bg-[var(--color-bg-secondary)] shadow-2xl">
        ...
        <div className="relative p-6 sm:p-8">
          ...
          <div className="mb-6 text-center">
            <div className="mb-2 inline-flex items-center gap-2 rounded-full border border-[var(--color-accent-cyan)]/30 bg-[var(--color-accent-cyan)]/10 px-3 py-1 font-mono text-[var(--color-accent-cyan)] text-xs">
          ...
          <div className="mb-6 space-y-4 text-center">
            <p className="text-[var(--color-text-secondary)] text-sm leading-relaxed sm:text-base">
              ...
              , created by Alex Tew in 2005. He sold 1 million pixels at $1 each
